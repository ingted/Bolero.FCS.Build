...
module internal SR =
    ...
    let ResourceManager = new System.Resources.ResourceManager("FSCore", C(0).GetType().GetTypeInfo().Assembly)
    ...
    let printfBadIntegerForDynamicFormatter = "printfBadIntegerForDynamicFormatter"
    ...
    let printfPrecisionSpecifierIllegal = "printfPrecisionSpecifierIllegal"
