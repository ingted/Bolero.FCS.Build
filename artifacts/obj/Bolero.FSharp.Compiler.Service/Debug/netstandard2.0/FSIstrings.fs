...
type internal SR private() =
    ...
    static member fsiGui(a0 : System.String) = (GetStringFunc("fsiGui",",,,%s,,,") a0)
    ...
    static member fsiReadline(a0 : System.String) = (GetStringFunc("fsiReadline",",,,%s,,,") a0)
    /// Emit debug information in quotations (%s by default)
    /// (Originally from Interactive\FSIstrings.txt:19)
    static member fsiEmitDebugInfoInQuotations(a0 : System.String) = (GetStringFunc("fsiEmitDebugInfoInQuotations",",,,%s,,,") a0)
    /// For help type #help;;
    ...
    static member fsiIntroTextHashhelpdocInfo() = (GetStringFunc("fsiIntroTextHashhelpdocInfo",",,,") )
    /// Exit
    ...
    static member shadowCopyReferences(a0 : System.String) = (GetStringFunc("shadowCopyReferences",",,,%s,,,") a0)
    ...
    static member fsiMultiAssemblyEmitOption(a0 : System.String) = (GetStringFunc("fsiMultiAssemblyEmitOption",",,,%s,,,") a0)
    ...
    static member fsiDetailedHelpLink() = (GetStringFunc("fsiDetailedHelpLink",",,,") )
    ...
    static member RunStartupValidation() =
        ...
        ignore(GetString("fsiIntroTextHashhelpdocInfo"))
        ...
        ignore(GetString("fsiDetailedHelpLink"))
        ()
